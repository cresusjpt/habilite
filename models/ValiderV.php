 ...
 */
class ValiderV extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['ID_HABILITE'], 'exist', 'skipOnError' => true, 'targetClass' => HabilitationV::className(), 'targetAttribute' => ['ID_HABILITE' => 'ID_HABILITE']],
    ...
    {
        return $this->hasOne(HabilitationV::className(), ['ID_HABILITE' => 'ID_HABILITE']);
    }
